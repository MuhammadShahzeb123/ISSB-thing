...
const area = getPreparationArea("physical");

export default function PhysicalOverviewPage() {
  return (
    <div className="neo-page px-4 py-12 sm:px-6">
      <div className="mx-auto max-w-4xl">
        ...
        <section className="mt-10 border-2 border-slate-950 bg-white p-6 shadow-[6px_6px_0_#171717] sm:p-8">
          <h2 className="text-2xl font-black">Build the foundation</h2>
          <p className="mt-3 leading-7 text-slate-700">
            Prioritise consistent conditioning, mobility, sleep, hydration, and gradual progress. Follow
            professional medical or training advice where needed.
          </p>
        </section>
        <div className="mt-8">
          <PracticeDisclaimer />
