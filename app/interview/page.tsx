...
export default function InterviewPage() {
  ...
  return (
    <div className="neo-page neo-page--leadership prep-page"><div className="prep-shell">
      ...
      <div className="prep-tabs" aria-label="Interview preparation areas">{[['introduction', 'Your introduction'], ['maths', 'Quick maths'], ['affairs', 'Current affairs'], ['stories', '11 gallantry stories'], ['knowledge', 'General knowledge'], ['source', 'Photo question bank']].map(([id, label]) => <button key={id} type="button" aria-pressed={tab === id} onClick={() => setTab(id)}>{label}</button>)}</div>
